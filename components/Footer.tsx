    ...
    <>
      <footer className="bg-[#FDFCF8] py-12 border-t border-stone-200">
        <div className="container mx-auto px-6">
            ...
            <div className="mt-16 flex flex-col md:flex-row justify-between items-center text-xs text-stone-400 gap-4">
                <p className="font-[Manrope]">© 2026 KLCLAB Inc. All rights reserved.</p>
